...
describe Ticket do
  describe "validations" do
    let(:model) { Factory.build :ticket }
    ...
    it "should have a short status" do
      model.status = 'this is a really really totally stupid ridiculously long name for a model that no one will ever remember'
      model.should be_invalid
    end
